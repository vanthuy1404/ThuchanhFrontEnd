...
let arrSV =[
    new SinhVien(1,"Ha Anh Nguyen", '1995-2-5', 'Nam', 'CNTT' ),
    new SinhVien(2,"Ha Anh Pha", '1995-3-5', 'Nam', 'Van' ),
    new SinhVien(3,"Ha Do Pha", '1736-3-5', 'Nu', 'Toan'),
    new SinhVien(4,"Dao Ha Anh Pha,", '1999-3-5', 'Nam', 'TiengAnh' ),
...
function hienthiSinhVien(data){
    ...
    data.forEach(sv => {
        ...
        <td><input type="checkbox" class ="check" data-masv = "${sv.MaSV}"></td>
                    ...
                    <td>${sv.GioiTinh}</td>
                    <td>${sv.MaKhoa}</td>
                    <td><a href="#"  data-masv = "${sv.MaSV}">Sửa</a>
                        <a href="#" data-masv = "${sv.MaSV}">Xóa</a>
                    </td>
        `
...
document.getElementById("search-result").innerHTML ="Kết quả tìm kiếm dưới bảng sau:"
